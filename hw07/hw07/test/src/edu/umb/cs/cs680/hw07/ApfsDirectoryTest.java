...
public class ApfsDirectoryTest{
	...
	public void verifyApfsDirectoryEqualityRoot (){
		...
		ApfsDirectory actual = new ApfsDirectory(null, "RootDir", 0, d1);
	...
	public void verifyApfsDirectoryEqualityHome ()
	{
		...
		ApfsDirectory actual = new ApfsDirectory(root, "Home", 0, d1);	
		fs.setRoot(root);
	...
	public void verifyApfsDirectoryTotalSize ()
	{
		...
		ApfsDirectory files = new ApfsDirectory(home, "files", 0, d1);
		ApfsDirectory actual = new ApfsDirectory(root, "Home", 0, d1);
		ApfsFile f1 = new ApfsFile(files, "notes1", 3000, d1);
		ApfsFile f2 = new ApfsFile(files, "notes1", 5000, d1);
		ApfsFile f3 = new ApfsFile(files, "notes2", 8000, d1);
		fs.setRoot(root);
		fs.AddChild(root, home);
		fs.AddChild(root, system);
		fs.AddChild(home, files);
